...
function onDeviceReady() {
          ...
          function addElement(pagina) {
                    ...
                    let nuevoElemento = $('<li><a id="'+uniqueId+'" href="#' + pagina + '">' + pagina + '</a><a class="edit ui-btn ui-btn-icon-notext ui-icon-edit" data-icon="edit"></a><a class="delete" data-icon="delete"></a></li>');
